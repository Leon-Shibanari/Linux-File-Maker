...
# Date Last Revised: October 6, 2022
...
echo "" >> $path
echo "//Libraries" >> $path
echo "#include<stdio.h>		//Standard Library" >> $path

#now we check if there are any more libraries we need to add
echo Aside from the library stdio.h, are there any other libraries? "[y/n]"
read loop
clear
